  ...
  return (
    <div className="container mx-auto py-2">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="upload" className="space-y-4">
              <div className="border-2 border-dashed rounded-lg p-12 text-center">
                ...
                <p className="text-gray-600 mb-2">Upload an image to caption</p>
            ...
            <TabsContent value="caption" className="space-y-4">
              ...
              <div>
                <label className="text-sm mb-2 block">
                  What would you like to caption?
                </label>
                <Textarea
              ...
              <Button onClick={handleCaption} className="w-full">
                Apply Captions
              </Button>

              <Card className="p-4">
                <h3 className="text-sm mb-2">Quick Captions</h3>
                <div className="space-y-2 text-sm">
                  {[
                    ...
                    <button
                      key={i}
                      onClick={() => setCaptionPrompt(suggestion)}
              ...
              {captionedImage ? (
                <>
                  ...
                  <Card className="p-4 bg-green-50 border-green-200">
                    <p className="text-sm">
                      ✓ Captions applied successfully: {captionPrompt}
                    </p>
                  </Card>
        ...
        <Card className="p-8 border-none rounded-3xl">
          <h2 className="mb-4">Captioning Capabilities</h2>
          ...
          <Card className="p-4 mt-6">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li>• Try multiple variations to find the perfect caption</li>
              <li>• Combine multiple captions for complex transformations</li>
            </ul>
          </Card>
        </Card>
      </div>
